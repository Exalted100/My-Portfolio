    ...
    return (
        <div className="projects-container">
            ...
            <div className="inner-projects-container">
                ...
                <Project image={TodoList} project="TO DO LIST" live="" code="https://github.com/Exalted100/Todo-list" projectInfo="Is there any front end web developer that hasn't built a todo list? Is there really? And so, like all the others in this profession, I have joined the hall of hackneyed project creators." />
